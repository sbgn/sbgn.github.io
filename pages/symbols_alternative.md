...
![Stimulation](downloads/symbols/Symbol-stimulation.png){: .center-image }
...
![Stimulation example](downloads/symbols/SymbolMonth-stimulation-example.png){: .center-image }

The following actual example describes calcium stimulating the conversion of inactive calmodulin into active one.

![Stimulation example real](downloads/symbols/SymbolMonth-stimulation-example-real.png){: .center-image }
...
![Stimulation example real 2](downloads/symbols/SymbolMonth-stimulation-example-real-2.png){: .center-image }

Download the stimulation arc image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-stimulation.sbgn) ] [ [GML](downloads/symbols/Symbol-stimulation.gml) ] [ [GraphML](downloads/symbols/Symbol-stimulation.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/stimulation/Symbol-stimulation.svg) ] [ [Open Document Format](downloads/symbols/Symbol-stimulation.odp) ] [ [PowerPoint](downloads/symbols/Symbol-stimulation.ppt) ] [ [PDF](downloads/symbols/Symbol-stimulation.pdf) ] [ [PNG](downloads/symbols/Symbol-stimulation.png) ]
...
![Inhibition](downloads/symbols/Symbol-inhibition.png){: .center-image }

The following generic example describes an entity C that inhibits the process transforming an entity A into an entity B.

![Inhibition example](downloads/symbols/SymbolMonth-inhibition-example.png){: .center-image }

The following actual example describes the protein Gαi inhibiting the conversion of ATP into cAMP.

![Inhibition example real](downloads/symbols/SymbolMonth-inhibition-example-real.png){: .center-image }

 Download the inhibition arc image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-inhibition.sbgn) ] [ [GML](downloads/symbols/Symbol-inhibition.gml) ] [ [GraphML](downloads/symbols/Symbol-inhibition.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/inhibition/Symbol-inhibition.svg) ] [ [Open Document Format](downloads/symbols/Symbol-inhibition.odp) ] [ [PowerPoint](downloads/symbols/Symbol-inhibition.ppt) ] [ [PDF](downloads/symbols/Symbol-inhibition.pdf) ] [ [PNG](downloads/symbols/Symbol-inhibition.png) ]
...
![Process](downloads/symbols/Symbol-process.png){: .center-image }

The following generic example describes an entity C that stimulates the process transforming an entity A into an entity B.

![Process example](downloads/symbols/SymbolMonth-process-example.png){: .center-image }

The following example describes the conversion of glucose into glucose 6 phosphate, stimulated by the enzyme hexokinase.

![Process example real](downloads/symbols/SymbolMonth-process-example-real.png){: .center-image }
...
![Process example real 2](downloads/symbols/SymbolMonth-process-example-real-2.png){: .center-image }
...
![Process example real 3](downloads/symbols/SymbolMonth-process-example-real-3.png){: .center-image }

Download the process node image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-process.sbgn) ] [ [GML](downloads/symbols/Symbol-process.gml) ] [ [GraphML](downloads/symbols/Symbol-process.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/process/Symbol-process.svg) ] [ [Open Document Format](downloads/symbols/Symbol-process.odp) ] [ [PowerPoint](downloads/symbols/Symbol-process.ppt) ] [ [PDF](downloads/symbols/Symbol-process.pdf) ] [ [PNG](downloads/symbols/Symbol-process.png) ]
...
![Consumption Production](downloads/symbols/Symbol-consumption_production.png){: .center-image }
...
![Consumption Production example](downloads/symbols/SymbolMonth-consumption_production-example.png){: .center-image }

A reaction or a transport can be reversible. In that case, both side of the process are linked to production arcs:

![Reversible](downloads/symbols/Symbol-reversible.png){: .center-image }
...
![Consumption Production example real](downloads/symbols/SymbolMonth-consumption_production-example-real.png){: .center-image }

The following example describes the reversible conversion of the glutamate ionotropic receptor between closed and open states.

![Reversible example real](downloads/symbols/SymbolMonth-reversible-example-real.png){: .center-image }

Download the consumption and production arcs images as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-consumption_production.sbgn) ] [ [GML](downloads/symbols/Symbol-consumption_production.gml) ] [ [GraphML](downloads/symbols/Symbol-consumption_production.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/consumption_production/Symbol-consumption_production.svg) ] [ [Open Document Format](downloads/symbols/Symbol-consumption_production.odp) ] [ [PowerPoint](downloads/symbols/Symbol-consumption_production.ppt) ] [ [PDF](downloads/symbols/Symbol-consumption_production.pdf) ] [ [PNG](downloads/symbols/Symbol-consumption_production.png) ]
...
![Macromolecule](downloads/symbols/Symbol-macromolecule.png){: .center-image }
...
![Macromolecule exampe real 1](downloads/symbols/Symbol-macromolecule-example-real-1.png){: .center-image }
...
![Macromolecule example real 2](downloads/symbols/Symbol-macromolecule-example-real-2.png){: .center-image }
...
![Macromolecule example real 3](downloads/symbols/Symbol-macromolecule-example-real-3.png){: .center-image }

Download the macromolecule node image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-macromolecule.sbgn) ] [ [GML](downloads/symbols/Symbol-macromolecule.gml) ] [ [GraphML](downloads/symbols/Symbol-macromolecule.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/macromolecule/Symbol-macromolecule.svg) ] [ [Open Document Format](downloads/symbols/Symbol-macromolecule.odp) ] [ [PowerPoint](downloads/symbols/Symbol-macromolecule.ppt) ] [ [PDF](downloads/symbols/Symbol-macromolecule.pdf) ] [ [PNG](downloads/symbols/Symbol-macromolecule.png) ]
...
![Simple chemical](downloads/symbols/Symbol-simpleChemical.png){: .center-image }

The following example describes the conversion of glucose into glucose 6 phosphate, stimulated by the enzyme hexokinase, represented as a macromolecule.

![Simple chemical example real 1](downloads/symbols/Symbol-simpleChemical-example-real-1.png){: .center-image }

The following example describes calcium stimulating the conversion of inactive calmodulin into active one.

![Simple chemical example real 2](downloads/symbols/Symbol-simpleChemical-example-real-2.png){: .center-image }

The following example describes the protein Gαi inhibiting the conversion of ATP into cAMP.

![Simple chemical example real 3](downloads/symbols/Symbol-simpleChemical-example-real-3.png){: .center-image }

Download the macromolecule node image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-simpleChemical.sbgn) ] [ [GML](downloads/symbols/Symbol-simpleChemical.gml) ] [ [GraphML](downloads/symbols/Symbol-simpleChemical.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/simple_chemical/Symbol-simpleChemical.svg) ] [ [Open Document Format](downloads/symbols/Symbol-simpleChemical.odp) ] [ [PowerPoint](downloads/symbols/Symbol-simpleChemical.ppt) ] [ [PDF](downloads/symbols/Symbol-simpleChemical.pdf) ] [ [PNG](downloads/symbols/Symbol-simpleChemical.png) ]
...
![Catalysis](downloads/symbols/Symbol-catalysis.png){: .center-image }

The following generic example describes an entity C that catalyses the process transforming an entity A into an entity B.

![Catalysis example](downloads/symbols/Symbol-catalysis-example.png){: .center-image }
...
![Catalysis example real](downloads/symbols/Symbol-catalysis-example-real.png){: .center-image }

Download the process node image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-catalysis.sbgn) ] [ [GML](downloads/symbols/Symbol-catalysis.gml) ] [ [GraphML](downloads/symbols/Symbol-catalysis.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/catalysis/Symbol-catalysis.svg) ] [ [Open Document Format](downloads/symbols/Symbol-catalysis.odp) ] [ [PowerPoint](downloads/symbols/Symbol-catalysis.ppt) ] [ [PDF](downloads/symbols/Symbol-catalysis.pdf) ] [ [PNG](downloads/symbols/Symbol-catalysis.png) ]
...
![Nucleic Acid Feature](downloads/symbols/Symbol-nucleicAcidFeature.png){: .center-image }

The following example describes the synthesis of a protein from amino-acids, triggered ("necessary stimulated") by mRNA.

![Nucleic Acid Feature](downloads/symbols/Symbol-nucleicAcidFeature-example-1.png){: .center-image }

Download the nucleic acid feature node image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-nucleicAcidFeature.sbgn) ] [ [GML](downloads/symbols/Symbol-nucleicAcidFeature.gml) ] [ [GraphML](downloads/symbols/Symbol-nucleicAcidFeature.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/nucleic_acid_feature/Symbol-nucleicAcidFeature.svg) ] [ [Open Document Format](downloads/symbols/Symbol-nucleicAcidFeature.odp) ] [ [PowerPoint](downloads/symbols/Symbol-nucleicAcidFeature.ppt) ] [ [PDF](downloads/symbols/Symbol-nucleicAcidFeature.pdf) ] [ [PNG](downloads/symbols/Symbol-nucleicAcidFeature.png) ]
...
![Complex](downloads/symbols/Symbol-complex.png){: .center-image }
...
![Complex example 1](downloads/symbols/Symbol-complex-example-1.png){: .center-image }
...
![Complex example 2](downloads/symbols/Symbol-complex-example-2.png){: .center-image }

Download the complex node image as (from the more semantic to the more generic):
[ [SBGN-ML](downloads/symbols/Symbol-complex.sbgn) ] [ [GML](downloads/symbols/Symbol-complex.gml) ] [ [GraphML](downloads/symbols/Symbol-complex.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/complex/Symbol-complex.svg) ] [ [Open Document Format](downloads/symbols/Symbol-complex.odp) ] [ [PowerPoint](downloads/symbols/Symbol-complex.ppt) ] [ [PDF](downloads/symbols/Symbol-complex.pdf) ] [ [PNG](downloads/symbols/Symbol-complex.png) ]
...
![Compartment](downloads/symbols/Symbol-compartment.png){: .center-image }
...
![Compartment example 1](downloads/symbols/Symbol-compartment-example-1.png){: .center-image }
...
![Compartment example 2](downloads/symbols/Symbol-compartment-example-2.png){: .center-image }
...
![Compartment example 3](downloads/symbols/Symbol-compartment-example-3.png){: .center-image }

Download the compartment node image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-compartment.sbgn) ] [ [GML](downloads/symbols/Symbol-compartment.gml) ] [ [GraphML](downloads/symbols/Symbol-compartment.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/compartment/Symbol-compartment.svg) ] [ [Open Document Format](downloads/symbols/Symbol-compartment.odp) ] [ [PowerPoint](downloads/symbols/Symbol-compartment.ppt) ] [ [PDF](downloads/symbols/Symbol-compartment.pdf) ] [ [PNG](downloads/symbols/Symbol-compartment.png) ]
...
![Clone marker](downloads/symbols/Symbol-clone-marker.png){: .center-image }
...
![Clone marker](downloads/symbols/Symbol-clone-marker-example-1.png){: .center-image }
...
![Clone marker](downloads/symbols/Symbol-clone-marker-example-2.png){: .center-image }


Download the clone marker node image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-clone-marker.sbgn) ] [ [GML](downloads/symbols/Symbol-clone-marker.gml) ] [ [GraphML](downloads/symbols/Symbol-clone-marker.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/clone_marker/Symbol-clone-marker.svg) ] [ [Open Document Format](downloads/symbols/Symbol-clone-marker.odp) ] [ [PowerPoint](downloads/symbols/Symbol-clone-marker.ppt) ] [ [PDF](downloads/symbols/Symbol-clone-marker.pdf) ] [ [PNG](downloads/symbols/Symbol-clone-marker.png) ]
...
![Biological activity](downloads/symbols/Symbol-biological-activity.png){: .center-image }
...
![Biological activity example 1](downloads/symbols/Symbol-biological-activity-example-1.png){: .center-image }
...
![Biological activity example 2](downloads/symbols/Symbol-biological-activity-example-2.png){: .center-image }
...
![Biological activity example 3](downloads/symbols/Symbol-biological-activity-example-3.png){: .center-image }


Download the biological activity node image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-biological-activity.sbgn) ] [ [GML](downloads/symbols/Symbol-biological-activity.gml) ] [ [GraphML](downloads/symbols/Symbol-biological-activity.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/biological_activity/Symbol-biological-activity.svg) ] [ [Open Document Format](downloads/symbols/Symbol-biological-activity.odp) ] [ [PowerPoint](downloads/symbols/Symbol-biological-activity.ppt) ] [ [PDF](downloads/symbols/Symbol-biological-activity.pdf) ] [ [PNG](downloads/symbols/Symbol-biological-activity.png) ]
...
![Unit of information for Biological Activity](downloads/symbols/Symbol-UnitOfInfo-BA.png){: .center-image }
...
|   | Name | Description |
|:-:|:----:|:-----------:|
|![Macromolecule](downloads/symbols/Symbol-UnitOfInfo-BA-macromolecule.png) | Macromolecule | Represents a very large biochemical substance, usually a protein, a nucleic acid or a complex sugar. It’s unit of information is represented by a rectangle with rounded corners.| 	
|![Simple chemical](downloads/symbols/Symbol-UnitOfInfo-BA-simplechemical.png)| Simple Chemical | Represents a small biochemical substance, usually an atom, a mono-atomic ion, a salt, a solid metal, etc. It’s unit of information is represented by a circular container. |
|![Nucleic acid feature](downloads/symbols/Symbol-UnitOfInfo-BA-nucleicacidfeature.png)| Nucleic acid feature | In SBGN represents a fragment of a macromolecule carrying genetic information. It’s unit of information is represented by a rectangle whose bottom half has rounded corners. |
|![Unspecified entity](downloads/symbols/Symbol-UnitOfInfo-BA-unspecifiedentity.png) | Unspecified entity | Represents the entity type that is unknown or simply not relevant for the purposes of the maps. It’s unit of information is represented by an elliptic container. |
|![Complex](downloads/symbols/Symbol-UnitOfInfo-BA-complex.png)| Complex | Represents a biochemical entity composed of other biochemical entities, whether macromolecules, simple chemicals or other complexes. It’s unit of information is represented by an octagon container. |
|![Perturbation](downloads/symbols/Symbol-UnitOfInfo-BA-perturbation.png)| Perturbation | Represents a physical phenomena that influence a biochemical network, such as a light pulse or a change in the temperature. It can also be more complex and not well defined, for instance, glucose deprivation or stress. It’s unit of information is represented by a modified hexagon container having two opposite concave faces. |
...
![Unit of information for Biological Activity](downloads/symbols/Symbol-UnitOfInfo-BA-example-1.png){: .center-image }


Download the unit of information for a biological activity image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-UnitOfInfo-BA.sbgn) ] [ [GML](downloads/symbols/Symbol-UnitOfInfo-BA.gml) ] [ [GraphML](downloads/symbols/Symbol-UnitOfInfo-BA.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/unit_of_information_ba/Symbol-UnitOfInfo-BA.svg) ] [ [Open Document Format](downloads/symbols/Symbol-UnitOfInfo-BA.odp) ] [ [PowerPoint](downloads/symbols/Symbol-UnitOfInfo-BA.ppt) ] [ [PDF](downloads/symbols/Symbol-UnitOfInfo-BA.pdf) ] [ [PNG](downloads/symbols/Symbol-UnitOfInfo-BA.png) ]
...
![Perturbing agent](downloads/symbols/Symbol-perturbingAgent.png){: .center-image }
...
![Perturbing agent example 1](downloads/symbols/Symbol-perturbingAgent-example-1.png){: .center-image }

Download the perturbing agent image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-perturbingAgent.sbgn) ] [ [GML](downloads/symbols/Symbol-perturbingAgent.gml) ] [ [GraphML](downloads/symbols/Symbol-perturbingAgent.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/perturbing_agent/Symbol-perturbingAgent.svg) ] [ [Open Document Format](downloads/symbols/Symbol-perturbingAgent.odp) ] [ [PowerPoint](downloads/symbols/Symbol-perturbingAgent.ppt) ] [ [PDF](downloads/symbols/Symbol-perturbingAgent.pdf) ] [ [PNG](downloads/symbols/Symbol-perturbingAgent.png) ]
...
![Unspecified entity](downloads/symbols/Symbol-unspecEntity.png){: .center-image }

As it is an EPN, the unspecified entity can carry a clone marker.

![Unspecified entity example 1](downloads/symbols/Symbol-unspecEntity-example-1.png){: .center-image }
...
![Unspecified entity example 2](downloads/symbols/Symbol-unspecEntity-example-2.png){: .center-image }

Download the unspecified entity glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-unspecEntity.sbgn) ] [ [GML](downloads/symbols/Symbol-unspecEntity.gml) ] [ [GraphML](downloads/symbols/Symbol-unspecEntity.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/unspecified_entity/Symbol-unspecEntity.svg) ] [ [Open Document Format](downloads/symbols/Symbol-unspecEntity.odp) ] [ [PowerPoint](downloads/symbols/Symbol-unspecEntity.ppt) ] [ [PDF](downloads/symbols/Symbol-unspecEntity.pdf) ] [ [PNG](downloads/symbols/Symbol-unspecEntity.png) ]
...
![Source and sink](downloads/symbols/Symbol-SourceAndSink.png){: .center-image }
...
![Source and sink example 1](downloads/symbols/Symbol-SourceAndSink-example1.png){: .center-image }
...
![Source and sink example 2](downloads/symbols/Symbol-SourceAndSink-example2.png){: .center-image }
...
![Source and sink example 3](downloads/symbols/Symbol-SourceAndSink-example3.png){: .center-image }

Download the source and sink glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-SourceAndSink.sbgn) ] [ [GML](downloads/symbols/Symbol-SourceAndSink.gml) ] [ [GraphML](downloads/symbols/Symbol-SourceAndSink.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/source_and_sink/Symbol-SourceAndSink.svg) ] [ [Open Document Format](downloads/symbols/Symbol-SourceAndSink.odp) ] [ [PowerPoint](downloads/symbols/Symbol-SourceAndSink.ppt) ] [ [PDF](downloads/symbols/Symbol-SourceAndSink.pdf) ] [ [PNG](downloads/symbols/Symbol-SourceAndSink.png) ]
...
![And](downloads/symbols/Symbol-and.png){: .center-image }
...
![And example pd](downloads/symbols/Symbol-and-example-pd.png){: .center-image }

In Activity Flow language:
![And example af](downloads/symbols/Symbol-and-example-af.png){: .center-image }

Download the and glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-and.sbgn) ] [ [GML](downloads/symbols/Symbol-and.gml) ] [ [GraphML](downloads/symbols/Symbol-and.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/and/Symbol-and.svg) ] [ [Open Document Format](downloads/symbols/Symbol-and.odp) ] [ [PowerPoint](downloads/symbols/Symbol-and.ppt) ] [ [PDF](downloads/symbols/Symbol-and.pdf) ] [ [PNG](downloads/symbols/Symbol-and.png) ]
...
![Or](downloads/symbols/Symbol-or.png){: .center-image }
...
![Or example](downloads/symbols/Symbol-or-example.png){: .center-image }

Download the or glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-or.sbgn) ] [ [GML](downloads/symbols/Symbol-or.gml) ] [ [GraphML](downloads/symbols/Symbol-or.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/or/Symbol-or.svg) ] [ [Open Document Format](downloads/symbols/Symbol-or.odp) ] [ [PowerPoint](downloads/symbols/Symbol-or.ppt) ] [ [PDF](downloads/symbols/Symbol-or.pdf) ] [ [PNG](downloads/symbols/Symbol-or.png) ]
...
![Not](downloads/symbols/Symbol-not.png){: .center-image }

The following example shows that the production of cyclin-CDK complex is not stimulated by the protein p21. 

![Not example](downloads/symbols/Symbol-not-example-pd.png){: .center-image }

Download the not glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](downloads/symbols/Symbol-not.sbgn) ] [ [GML](downloads/symbols/Symbol-not.gml) ] [ [GraphML](downloads/symbols/Symbol-not.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/not/Symbol-not.svg) ] [ [Open Document Format](downloads/symbols/Symbol-not.odp) ] [ [PowerPoint](downloads/symbols/Symbol-not.ppt) ] [ [PDF](downloads/symbols/Symbol-not.pdf) ] [ [PNG](downloads/symbols/Symbol-not.png) ]
