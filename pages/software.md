...
* [Editors](#editors)
* [Visualisers and Formats Converters](#visualisers-and-formats-converters)
...
<td style="text-align:center"><font size="5">&#9744;</font></td>
<td style="text-align:center"><font size="5">&#9744;</font></td>
<td style="text-align:center">CellDesigner &rarr; SBML-qual</td>
...
The implementation of SBGN support in software packages may be facilitated by the use of the XML-based file format [SBGN-ML](https://pmc.ncbi.nlm.nih.gov/articles/PMC7756621/). SBGN-ML can be processed and generated by the standard library [LibSBGN](https://github.com/sbgn/libsbgn). LibSBGN is a community project and everyone is welcome to participate.

Discussions around SBGN-ML and LibSBGN take place on [sbgn-discuss](mailto:sbgn-discuss@googlegroups.com).
