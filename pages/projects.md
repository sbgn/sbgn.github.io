...
<table>
    <tr>
        <td style="width:380px; vertical-align:top;  text-align:left;">
            The <a href="https://minerva.pages.uni.lu/" target="_blank">MINERVA</a> platform supports SBGN view for CellDesigner maps, enables import and export of SBGN 0.2 and soon SBGN 0.3. Other interesting features of MINERVA include easy export and import of CellDesigner XML format, annotation of maps on upload, support of background images, import and export of SBML with layout information.
        </td>
        <td style="text-align:left; vertical-align:top; text-align:left; padding-left:1em;">
