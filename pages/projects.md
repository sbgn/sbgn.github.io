...
<table>
    <tr>
        <td style="width:380px; vertical-align:top;  text-align:left;">
            <a href="https://lifeware.inria.fr/~soliman/post/casq/" target="_blank"> is a tool that infers Boolean rules based on the topology and semantics of process diagrams built in CellDesigner. It converts CellDesigner XML to SBML-Qual-encoded logical model. The converter is actively used in the <a href="https://covid.pages.uni.lu/" target="_blank">COVID-19 Disease Map</a> project.</a>
        </td>
        <td style="text-align:left; vertical-align:top; text-align:left; padding-left:1em;">
