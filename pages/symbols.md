...
![Stimulation](dowloads/symbols/Symbol-stimulation.png){: .center-image }
...
![Stimulation example](dowloads/symbols/SymbolMonth-stimulation-example.png){: .center-image }

The following actual example describes calcium stimulating the conversion of inactive calmodulin into active one.

![Stimulation example real](dowloads/symbols/SymbolMonth-stimulation-example-real.png){: .center-image }
...
![Stimulation example real 2](dowloads/symbols/SymbolMonth-stimulation-example-real-2.png){: .center-image }

Download the stimulation arc image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-stimulation.sbgn) ] [ [GML](dowloads/symbols/Symbol-stimulation.gml) ] [ [GraphML](dowloads/symbols/Symbol-stimulation.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/stimulation/Symbol-stimulation.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-stimulation.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-stimulation.ppt) ] [ [PDF](dowloads/symbols/Symbol-stimulation.pdf) ] [ [PNG](dowloads/symbols/Symbol-stimulation.png) ]
...
![Inhibition](dowloads/symbols/Symbol-inhibition.png){: .center-image }

The following generic example describes an entity C that inhibits the process transforming an entity A into an entity B.

![Inhibition example](dowloads/symbols/SymbolMonth-inhibition-example.png){: .center-image }

The following actual example describes the protein Gαi inhibiting the conversion of ATP into cAMP.

![Inhibition example real](dowloads/symbols/SymbolMonth-inhibition-example-real.png){: .center-image }

 Download the inhibition arc image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-inhibition.sbgn) ] [ [GML](dowloads/symbols/Symbol-inhibition.gml) ] [ [GraphML](dowloads/symbols/Symbol-inhibition.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/inhibition/Symbol-inhibition.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-inhibition.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-inhibition.ppt) ] [ [PDF](dowloads/symbols/Symbol-inhibition.pdf) ] [ [PNG](dowloads/symbols/Symbol-inhibition.png) ]
...
![Process](dowloads/symbols/Symbol-process.png){: .center-image }

The following generic example describes an entity C that stimulates the process transforming an entity A into an entity B.

![Process example](dowloads/symbols/SymbolMonth-process-example.png){: .center-image }

The following example describes the conversion of glucose into glucose 6 phosphate, stimulated by the enzyme hexokinase.

![Process example real](dowloads/symbols/SymbolMonth-process-example-real.png){: .center-image }
...
![Process example real 2](dowloads/symbols/SymbolMonth-process-example-real-2.png){: .center-image }
...
![Process example real 3](dowloads/symbols/SymbolMonth-process-example-real-3.png){: .center-image }

Download the process node image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-process.sbgn) ] [ [GML](dowloads/symbols/Symbol-process.gml) ] [ [GraphML](dowloads/symbols/Symbol-process.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/process/Symbol-process.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-process.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-process.ppt) ] [ [PDF](dowloads/symbols/Symbol-process.pdf) ] [ [PNG](dowloads/symbols/Symbol-process.png) ]
...
![Consumption Production](dowloads/symbols/Symbol-consumption_production.png){: .center-image }
...
![Consumption Production example](dowloads/symbols/SymbolMonth-consumption_production-example.png){: .center-image }

A reaction or a transport can be reversible. In that case, both side of the process are linked to production arcs:

![Reversible](dowloads/symbols/Symbol-reversible.png){: .center-image }
...
![Consumption Production example real](dowloads/symbols/SymbolMonth-consumption_production-example-real.png){: .center-image }

The following example describes the reversible conversion of the glutamate ionotropic receptor between closed and open states.

![Reversible example real](dowloads/symbols/SymbolMonth-reversible-example-real.png){: .center-image }

Download the consumption and production arcs images as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-consumption_production.sbgn) ] [ [GML](dowloads/symbols/Symbol-consumption_production.gml) ] [ [GraphML](dowloads/symbols/Symbol-consumption_production.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/consumption_production/Symbol-consumption_production.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-consumption_production.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-consumption_production.ppt) ] [ [PDF](dowloads/symbols/Symbol-consumption_production.pdf) ] [ [PNG](dowloads/symbols/Symbol-consumption_production.png) ]
...
![Macromolecule](dowloads/symbols/Symbol-macromolecule.png){: .center-image }
...
![Macromolecule exampe real 1](dowloads/symbols/Symbol-macromolecule-example-real-1.png){: .center-image }
...
![Macromolecule example real 2](dowloads/symbols/Symbol-macromolecule-example-real-2.png){: .center-image }
...
![Macromolecule example real 3](dowloads/symbols/Symbol-macromolecule-example-real-3.png){: .center-image }

Download the macromolecule node image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-macromolecule.sbgn) ] [ [GML](dowloads/symbols/Symbol-macromolecule.gml) ] [ [GraphML](dowloads/symbols/Symbol-macromolecule.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/macromolecule/Symbol-macromolecule.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-macromolecule.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-macromolecule.ppt) ] [ [PDF](dowloads/symbols/Symbol-macromolecule.pdf) ] [ [PNG](dowloads/symbols/Symbol-macromolecule.png) ]
...
![Simple chemical](dowloads/symbols/Symbol-simpleChemical.png){: .center-image }

The following example describes the conversion of glucose into glucose 6 phosphate, stimulated by the enzyme hexokinase, represented as a macromolecule.

![Simple chemical example real 1](dowloads/symbols/Symbol-simpleChemical-example-real-1.png){: .center-image }

The following example describes calcium stimulating the conversion of inactive calmodulin into active one.

![Simple chemical example real 2](dowloads/symbols/Symbol-simpleChemical-example-real-2.png){: .center-image }

The following example describes the protein Gαi inhibiting the conversion of ATP into cAMP.

![Simple chemical example real 3](dowloads/symbols/Symbol-simpleChemical-example-real-3.png){: .center-image }

Download the macromolecule node image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-simpleChemical.sbgn) ] [ [GML](dowloads/symbols/Symbol-simpleChemical.gml) ] [ [GraphML](dowloads/symbols/Symbol-simpleChemical.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/simple_chemical/Symbol-simpleChemical.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-simpleChemical.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-simpleChemical.ppt) ] [ [PDF](dowloads/symbols/Symbol-simpleChemical.pdf) ] [ [PNG](dowloads/symbols/Symbol-simpleChemical.png) ]
...
![Catalysis](dowloads/symbols/Symbol-catalysis.png){: .center-image }

The following generic example describes an entity C that catalyses the process transforming an entity A into an entity B.

![Catalysis example](dowloads/symbols/Symbol-catalysis-example.png){: .center-image }
...
![Catalysis example real](dowloads/symbols/Symbol-catalysis-example-real.png){: .center-image }

Download the process node image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-catalysis.sbgn) ] [ [GML](dowloads/symbols/Symbol-catalysis.gml) ] [ [GraphML](dowloads/symbols/Symbol-catalysis.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/catalysis/Symbol-catalysis.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-catalysis.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-catalysis.ppt) ] [ [PDF](dowloads/symbols/Symbol-catalysis.pdf) ] [ [PNG](dowloads/symbols/Symbol-catalysis.png) ]
...
![Nucleic Acid Feature](dowloads/symbols/Symbol-nucleicAcidFeature.png){: .center-image }

The following example describes the synthesis of a protein from amino-acids, triggered ("necessary stimulated") by mRNA.

![Nucleic Acid Feature](dowloads/symbols/Symbol-nucleicAcidFeature-example-1.png){: .center-image }

Download the nucleic acid feature node image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-nucleicAcidFeature.sbgn) ] [ [GML](dowloads/symbols/Symbol-nucleicAcidFeature.gml) ] [ [GraphML](dowloads/symbols/Symbol-nucleicAcidFeature.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/nucleic_acid_feature/Symbol-nucleicAcidFeature.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-nucleicAcidFeature.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-nucleicAcidFeature.ppt) ] [ [PDF](dowloads/symbols/Symbol-nucleicAcidFeature.pdf) ] [ [PNG](dowloads/symbols/Symbol-nucleicAcidFeature.png) ]
...
![Complex](dowloads/symbols/Symbol-complex.png){: .center-image }
...
![Complex example 1](dowloads/symbols/Symbol-complex-example-1.png){: .center-image }
...
![Complex example 2](dowloads/symbols/Symbol-complex-example-2.png){: .center-image }

Download the complex node image as (from the more semantic to the more generic):
[ [SBGN-ML](dowloads/symbols/Symbol-complex.sbgn) ] [ [GML](dowloads/symbols/Symbol-complex.gml) ] [ [GraphML](dowloads/symbols/Symbol-complex.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/complex/Symbol-complex.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-complex.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-complex.ppt) ] [ [PDF](dowloads/symbols/Symbol-complex.pdf) ] [ [PNG](dowloads/symbols/Symbol-complex.png) ]
...
![Compartment](dowloads/symbols/Symbol-compartment.png){: .center-image }
...
![Compartment example 1](dowloads/symbols/Symbol-compartment-example-1.png){: .center-image }
...
![Compartment example 2](dowloads/symbols/Symbol-compartment-example-2.png){: .center-image }
...
![Compartment example 3](dowloads/symbols/Symbol-compartment-example-3.png){: .center-image }

Download the compartment node image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-compartment.sbgn) ] [ [GML](dowloads/symbols/Symbol-compartment.gml) ] [ [GraphML](dowloads/symbols/Symbol-compartment.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/compartment/Symbol-compartment.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-compartment.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-compartment.ppt) ] [ [PDF](dowloads/symbols/Symbol-compartment.pdf) ] [ [PNG](dowloads/symbols/Symbol-compartment.png) ]
...
![Clone marker](dowloads/symbols/Symbol-clone-marker.png){: .center-image }
...
![Clone marker](dowloads/symbols/Symbol-clone-marker-example-1.png){: .center-image }
...
![Clone marker](dowloads/symbols/Symbol-clone-marker-example-2.png){: .center-image }


Download the clone marker node image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-clone-marker.sbgn) ] [ [GML](dowloads/symbols/Symbol-clone-marker.gml) ] [ [GraphML](dowloads/symbols/Symbol-clone-marker.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/clone_marker/Symbol-clone-marker.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-clone-marker.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-clone-marker.ppt) ] [ [PDF](dowloads/symbols/Symbol-clone-marker.pdf) ] [ [PNG](dowloads/symbols/Symbol-clone-marker.png) ]
...
![Biological activity](dowloads/symbols/Symbol-biological-activity.png){: .center-image }
...
![Biological activity example 1](dowloads/symbols/Symbol-biological-activity-example-1.png){: .center-image }
...
![Biological activity example 2](dowloads/symbols/Symbol-biological-activity-example-2.png){: .center-image }
...
![Biological activity example 3](dowloads/symbols/Symbol-biological-activity-example-3.png){: .center-image }


Download the biological activity node image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-biological-activity.sbgn) ] [ [GML](dowloads/symbols/Symbol-biological-activity.gml) ] [ [GraphML](dowloads/symbols/Symbol-biological-activity.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/biological_activity/Symbol-biological-activity.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-biological-activity.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-biological-activity.ppt) ] [ [PDF](dowloads/symbols/Symbol-biological-activity.pdf) ] [ [PNG](dowloads/symbols/Symbol-biological-activity.png) ]
...
![Unit of information for Biological Activity](dowloads/symbols/Symbol-UnitOfInfo-BA.png){: .center-image }
...
|   | Name | Description |
|:-:|:----:|:-----------:|
|![Macromolecule](dowloads/symbols/Symbol-UnitOfInfo-BA-macromolecule.png) | Macromolecule | Represents a very large biochemical substance, usually a protein, a nucleic acid or a complex sugar. It’s unit of information is represented by a rectangle with rounded corners.| 	
|![Simple chemical](dowloads/symbols/Symbol-UnitOfInfo-BA-simplechemical.png)| Simple Chemical | Represents a small biochemical substance, usually an atom, a mono-atomic ion, a salt, a solid metal, etc. It’s unit of information is represented by a circular container. |
|![Nucleic acid feature](dowloads/symbols/Symbol-UnitOfInfo-BA-nucleicacidfeature.png)| Nucleic acid feature | In SBGN represents a fragment of a macromolecule carrying genetic information. It’s unit of information is represented by a rectangle whose bottom half has rounded corners. |
|![Unspecified entity](dowloads/symbols/Symbol-UnitOfInfo-BA-unspecifiedentity.png) | Unspecified entity | Represents the entity type that is unknown or simply not relevant for the purposes of the maps. It’s unit of information is represented by an elliptic container. |
|![Complex](dowloads/symbols/Symbol-UnitOfInfo-BA-complex.png)| Complex | Represents a biochemical entity composed of other biochemical entities, whether macromolecules, simple chemicals or other complexes. It’s unit of information is represented by an octagon container. |
|![Perturbation](dowloads/symbols/Symbol-UnitOfInfo-BA-perturbation.png)| Perturbation | Represents a physical phenomena that influence a biochemical network, such as a light pulse or a change in the temperature. It can also be more complex and not well defined, for instance, glucose deprivation or stress. It’s unit of information is represented by a modified hexagon container having two opposite concave faces. |
...
![Unit of information for Biological Activity](dowloads/symbols/Symbol-UnitOfInfo-BA-example-1.png){: .center-image }


Download the unit of information for a biological activity image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-UnitOfInfo-BA.sbgn) ] [ [GML](dowloads/symbols/Symbol-UnitOfInfo-BA.gml) ] [ [GraphML](dowloads/symbols/Symbol-UnitOfInfo-BA.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/unit_of_information_ba/Symbol-UnitOfInfo-BA.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-UnitOfInfo-BA.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-UnitOfInfo-BA.ppt) ] [ [PDF](dowloads/symbols/Symbol-UnitOfInfo-BA.pdf) ] [ [PNG](dowloads/symbols/Symbol-UnitOfInfo-BA.png) ]
...
![Perturbing agent](dowloads/symbols/Symbol-perturbingAgent.png){: .center-image }
...
![Perturbing agent example 1](dowloads/symbols/Symbol-perturbingAgent-example-1.png){: .center-image }

Download the perturbing agent image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-perturbingAgent.sbgn) ] [ [GML](dowloads/symbols/Symbol-perturbingAgent.gml) ] [ [GraphML](dowloads/symbols/Symbol-perturbingAgent.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/perturbing_agent/Symbol-perturbingAgent.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-perturbingAgent.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-perturbingAgent.ppt) ] [ [PDF](dowloads/symbols/Symbol-perturbingAgent.pdf) ] [ [PNG](dowloads/symbols/Symbol-perturbingAgent.png) ]
...
![Unspecified entity](dowloads/symbols/Symbol-unspecEntity.png){: .center-image }

As it is an EPN, the unspecified entity can carry a clone marker.

![Unspecified entity example 1](dowloads/symbols/Symbol-unspecEntity-example-1.png){: .center-image }
...
![Unspecified entity example 2](dowloads/symbols/Symbol-unspecEntity-example-2.png){: .center-image }

Download the unspecified entity glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-unspecEntity.sbgn) ] [ [GML](dowloads/symbols/Symbol-unspecEntity.gml) ] [ [GraphML](dowloads/symbols/Symbol-unspecEntity.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/unspecified_entity/Symbol-unspecEntity.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-unspecEntity.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-unspecEntity.ppt) ] [ [PDF](dowloads/symbols/Symbol-unspecEntity.pdf) ] [ [PNG](dowloads/symbols/Symbol-unspecEntity.png) ]
...
![Source and sink](dowloads/symbols/Symbol-SourceAndSink.png){: .center-image }
...
![Source and sink example 1](dowloads/symbols/Symbol-SourceAndSink-example1.png){: .center-image }
...
![Source and sink example 2](dowloads/symbols/Symbol-SourceAndSink-example2.png){: .center-image }
...
![Source and sink example 3](dowloads/symbols/Symbol-SourceAndSink-example3.png){: .center-image }

Download the source and sink glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-SourceAndSink.sbgn) ] [ [GML](dowloads/symbols/Symbol-SourceAndSink.gml) ] [ [GraphML](dowloads/symbols/Symbol-SourceAndSink.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/source_and_sink/Symbol-SourceAndSink.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-SourceAndSink.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-SourceAndSink.ppt) ] [ [PDF](dowloads/symbols/Symbol-SourceAndSink.pdf) ] [ [PNG](dowloads/symbols/Symbol-SourceAndSink.png) ]
...
![And](dowloads/symbols/Symbol-and.png){: .center-image }
...
![And example pd](dowloads/symbols/Symbol-and-example-pd.png){: .center-image }

In Activity Flow language:
![And example af](dowloads/symbols/Symbol-and-example-af.png){: .center-image }

Download the and glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-and.sbgn) ] [ [GML](dowloads/symbols/Symbol-and.gml) ] [ [GraphML](dowloads/symbols/Symbol-and.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/and/Symbol-and.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-and.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-and.ppt) ] [ [PDF](dowloads/symbols/Symbol-and.pdf) ] [ [PNG](dowloads/symbols/Symbol-and.png) ]
...
![Or](dowloads/symbols/Symbol-or.png){: .center-image }
...
![Or example](dowloads/symbols/Symbol-or-example.png){: .center-image }

Download the or glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-or.sbgn) ] [ [GML](dowloads/symbols/Symbol-or.gml) ] [ [GraphML](dowloads/symbols/Symbol-or.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/or/Symbol-or.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-or.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-or.ppt) ] [ [PDF](dowloads/symbols/Symbol-or.pdf) ] [ [PNG](dowloads/symbols/Symbol-or.png) ]
...
![Not](dowloads/symbols/Symbol-not.png){: .center-image }

The following example shows that the production of cyclin-CDK complex is not stimulated by the protein p21. 

![Not example](dowloads/symbols/Symbol-not-example-pd.png){: .center-image }

Download the not glyph image as (from the more semantic to the more generic):

[ [SBGN-ML](dowloads/symbols/Symbol-not.sbgn) ] [ [GML](dowloads/symbols/Symbol-not.gml) ] [ [GraphML](dowloads/symbols/Symbol-not.graphml) ] [ [SVG](https://cdn.rawgit.com/sbgn/glyph-files/master/not/Symbol-not.svg) ] [ [Open Document Format](dowloads/symbols/Symbol-not.odp) ] [ [PowerPoint](dowloads/symbols/Symbol-not.ppt) ] [ [PDF](dowloads/symbols/Symbol-not.pdf) ] [ [PNG](dowloads/symbols/Symbol-not.png) ]
