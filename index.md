...
## Exchange and storage format [SBGN-ML](https://pmc.ncbi.nlm.nih.gov/articles/PMC7756621/) and software [library](https://github.com/sbgn/libsbgn)

Various tools can export an import SBGN visualization in the XML-based file format [SBGN-ML](https://pmc.ncbi.nlm.nih.gov/articles/PMC7756621/). 
SBGN-ML can be processed and generated by the standard library [libSBGN](https://github.com/sbgn/libsbgn)
One can compare the rendering of SBGN-ML by different software packages on as previously done [libSBGN Render Comparison](https://pmc.ncbi.nlm.nih.gov/articles/PMC3400951/).
...
<a href="https://saezlab.github.io/cysbgn/">CySBGN</a> (SBML &rarr; SBGN), 
